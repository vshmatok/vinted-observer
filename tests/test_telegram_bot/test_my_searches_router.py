...
async def test_cmd_my_searches_query_error(mock_message, mock_message_bus):
...
async def test_cmd_my_searches_empty_list(mock_message, mock_message_bus):
...
async def test_cmd_my_searches_empty_list_send_error(mock_message, mock_message_bus):
    mock_message_bus.query.return_value = []
...
async def test_cmd_my_searches_single_search(
    mock_message, mock_message_bus, sample_nike_search
):
    mock_message_bus.query.return_value = [sample_nike_search]

    await cmd_my_searches(mock_message, mock_message_bus)

    expected_text, expected_markup = build_my_search_listing_message(sample_nike_search)
    mock_message.answer.assert_called_once_with(
        expected_text, reply_markup=expected_markup
    )


async def test_cmd_my_searches_sends_listing_per_search(
    mock_message, mock_message_bus, sample_nike_search
):
    search2 = Search(id=2, chat_id=12345, query="adidas", price_min=5.0, price_max=50.0)
...
async def test_cmd_my_searches_error_on_one_continues(
    mock_message, mock_message_bus, sample_nike_search
):
    search2 = Search(id=2, chat_id=12345, query="adidas", price_min=5.0, price_max=50.0)
    mock_message_bus.query.return_value = [sample_nike_search, search2]
...
async def test_cmd_my_searches_build_error_continues(
    mock_message, mock_message_bus, mocker
):
    search1 = Search(id=1, chat_id=12345, query="nike", price_min=10.0, price_max=100.0)
    search2 = Search(id=2, chat_id=12345, query="adidas", price_min=5.0, price_max=50.0)
...
async def test_handle_remove_button_missing_data(mock_callback_query, mock_message_bus):
...
async def test_handle_remove_button_missing_message(
    mock_callback_query, mock_message_bus
):
...
async def test_handle_remove_button_invalid_format(
    mock_callback_query, mock_message_bus
):
...
async def test_handle_remove_button_query_error(mock_callback_query, mock_message_bus):
    mock_callback_query.data = "remove_1"
    mock_message_bus.query.side_effect = Exception("db error")
...
async def test_handle_remove_button_not_found(mock_callback_query, mock_message_bus):
    mock_callback_query.data = "remove_1"
...
async def test_handle_remove_button_not_message_instance(
    mock_callback_query, mock_message_bus, sample_nike_search
):
    mock_callback_query.data = "remove_1"
    mock_message_bus.query.return_value = sample_nike_search
...
async def test_handle_remove_button_shows_confirmation(
    mock_callback_query, mock_message_bus, sample_nike_search
):
    mock_callback_query.data = "remove_1"
    mock_message_bus.query.return_value = sample_nike_search
...
async def test_confirm_delete_missing_data(mock_callback_query, mock_message_bus):
    mock_callback_query.data = None
...
async def test_confirm_delete_invalid_format(mock_callback_query, mock_message_bus):
...
async def test_confirm_delete_success(mock_callback_query, mock_message_bus):
    ...
    mock_callback_query.answer.assert_called_once_with("Search deleted successfully!")


async def test_confirm_delete_delete_error(mock_callback_query, mock_message_bus):
    mock_callback_query.data = "confirm_remove_1"
...
async def test_confirm_delete_not_message_instance(
    mock_callback_query, mock_message_bus
):
    mock_callback_query.data = "confirm_remove_1"
    mock_callback_query.message = MagicMock()  # Not a Message instance
...
async def test_cancel_delete_missing_data(mock_callback_query, mock_message_bus):
    mock_callback_query.data = None
...
async def test_cancel_delete_invalid_format(mock_callback_query, mock_message_bus):
...
async def test_cancel_delete_query_error(mock_callback_query, mock_message_bus):
...
async def test_cancel_delete_not_found(mock_callback_query, mock_message_bus):
    mock_callback_query.data = "cancel_remove_1"
    mock_message_bus.query.return_value = None
...
async def test_cancel_delete_restores_message_and_answers(
    mock_callback_query, mock_message_bus, sample_nike_search
):
    mock_callback_query.data = "cancel_remove_1"
    mock_message_bus.query.return_value = sample_nike_search
...
async def test_handle_edit_button_missing_data(
    mock_callback_query, mock_fsm_context, mock_message_bus
):
    mock_callback_query.data = None

    await handle_edit_button(mock_callback_query, mock_fsm_context, mock_message_bus)

    mock_fsm_context.set_state.assert_not_called()
    mock_message_bus.query.assert_not_called()


async def test_handle_edit_button_invalid_format(
    mock_callback_query, mock_fsm_context, mock_message_bus
):
...
async def test_handle_edit_button_query_error(
    mock_callback_query, mock_fsm_context, mock_message_bus
):
...
async def test_handle_edit_button_not_found(
    mock_callback_query, mock_fsm_context, mock_message_bus
):
    mock_callback_query.data = "edit_1"
    mock_message_bus.query.return_value = None
...
async def test_handle_edit_button_success(
    mock_callback_query,
    mock_fsm_context,
    mock_message_bus,
    sample_nike_search,
    ...
    mock_fsm_context.set_state.assert_called_once_with(EditSearchState.selecting_field)
    mock_callback_query.message.edit_text.assert_called_once()
...
async def test_handle_edit_button_error_clears_state(
    mock_callback_query,
    mock_fsm_context,
    mock_message_bus,
    sample_nike_search,
...
async def test_cancel_edit_missing_data(
    mock_callback_query, mock_fsm_context, mock_message_bus
):
    mock_callback_query.data = None
...
async def test_cancel_edit_invalid_format(
    mock_callback_query, mock_fsm_context, mock_message_bus
):
...
async def test_cancel_edit_query_error(
    mock_callback_query, mock_fsm_context, mock_message_bus
):
...
async def test_cancel_edit_not_found(
    mock_callback_query, mock_fsm_context, mock_message_bus
):
    mock_callback_query.data = "cancel_edit_1"
    mock_message_bus.query.return_value = None
...
async def test_cancel_edit_clears_state_and_restores_listing(
    mock_callback_query,
    mock_fsm_context,
    mock_message_bus,
    sample_nike_search,
...
async def test_cancel_edit_error_clears_state(
    mock_callback_query,
    mock_fsm_context,
    mock_message_bus,
    sample_nike_search,
...
async def test_handle_edit_field_missing_data(
    mock_callback_query, mock_fsm_context, mock_message_bus
):
    mock_callback_query.data = None
...
async def test_handle_edit_field_invalid_format(
    mock_callback_query, mock_fsm_context, mock_message_bus
):
...
async def test_handle_edit_field_missing_field(
    mock_callback_query, mock_fsm_context, mock_message_bus
):
...
async def test_handle_edit_field_query_error(
    mock_callback_query, mock_fsm_context, mock_message_bus
):
...
async def test_handle_edit_field_not_found(
    mock_callback_query, mock_fsm_context, mock_message_bus
):
    mock_callback_query.data = "editfield_1_query"
    mock_message_bus.query.return_value = None
...
async def test_handle_edit_field_invalid_field(
    mock_callback_query,
    mock_fsm_context,
    mock_message_bus,
    sample_nike_search,
...
async def test_handle_edit_field_sets_state_for_query(
    mock_callback_query,
    mock_fsm_context,
    mock_message_bus,
    sample_nike_search,
    ...
    mock_fsm_context.set_state.assert_called_once_with(EditSearchState.editing_query)


async def test_handle_edit_field_sets_state_for_min(
    mock_callback_query,
    mock_fsm_context,
    mock_message_bus,
    sample_nike_search,
...
async def test_handle_edit_field_sets_state_for_max(
    mock_callback_query,
    mock_fsm_context,
    mock_message_bus,
    sample_nike_search,
...
async def test_handle_edit_field_stores_data_in_state(
    mock_callback_query,
    mock_fsm_context,
    mock_message_bus,
    sample_nike_search,
...
async def test_handle_edit_field_sends_prompt_with_current_query(
    mock_callback_query,
    mock_fsm_context,
    mock_message_bus,
    sample_nike_search,
...
async def test_handle_edit_field_sends_prompt_with_current_min_value(
    mock_callback_query,
    mock_fsm_context,
    mock_message_bus,
    sample_nike_search,
...
async def test_handle_edit_field_sends_prompt_with_current_max_value(
    mock_callback_query,
    mock_fsm_context,
    mock_message_bus,
    sample_nike_search,
...
async def test_handle_edit_field_cancel_keyboard(
    mock_callback_query,
    mock_fsm_context,
    mock_message_bus,
    sample_nike_search,
...
async def test_handle_edit_field_error_clears_state(
    mock_callback_query,
    mock_fsm_context,
    mock_message_bus,
    sample_nike_search,
...
async def test_cancel_editfield_clears_state_and_sends_confirmation(
    mock_message, mock_fsm_context
):
...
async def test_edit_query_no_text(mock_message, edit_fsm_data, mock_message_bus):
...
async def test_edit_query_invalid_query(mock_message, edit_fsm_data, mock_message_bus):
    mock_message.text = "a"
...
async def test_edit_query_missing_search_id(
    mock_message, mock_fsm_context, mock_message_bus
):
...
async def test_edit_query_success(mock_message, edit_fsm_data, mock_message_bus):
    mock_message.text = "new query"
...
async def test_edit_query_update_error(mock_message, edit_fsm_data, mock_message_bus):
    mock_message.text = "new query"
...
async def test_edit_query_calls_update_message_helper(
    mock_message, edit_fsm_data, mock_message_bus, mocker
):
    mock_message.text = "new query"
    helper = mocker.patch(
...
async def test_edit_query_unexpected_error_clears(
    mock_message, mock_fsm_context, mock_message_bus
):
    mock_message.text = "new query"
...
async def test_edit_query_no_bot_skips_helper(
    mock_message, edit_fsm_data, mock_message_bus, mocker
):
    mock_message.text = "new query"
...
# ---------------------------------------------------------------------------
# edit_price_min / edit_price_max  (parametrized)
# ---------------------------------------------------------------------------


@_price_params
async def test_edit_price_no_text(
    handler,
    valid_text,
    invalid_range_text,
    expected_value,
...
@_price_params
async def test_edit_price_non_numeric(
    handler,
    valid_text,
    invalid_range_text,
    expected_value,
...
@_price_params
async def test_edit_price_missing_search_id(
    handler,
    valid_text,
    invalid_range_text,
    expected_value,
...
@_price_params
async def test_edit_price_query_error(
    handler,
    valid_text,
    invalid_range_text,
    expected_value,
...
@_price_params
async def test_edit_price_not_found(
    handler,
    valid_text,
    invalid_range_text,
    expected_value,
...
@_price_params
async def test_edit_price_invalid_range(
    handler,
    valid_text,
    invalid_range_text,
    expected_value,
...
@_price_params
async def test_edit_price_executes_update(
    handler,
    valid_text,
    invalid_range_text,
    expected_value,
...
@_price_params
async def test_edit_price_publishes_event(
    handler,
    valid_text,
    invalid_range_text,
    expected_value,
...
@_price_params
async def test_edit_price_clears_state(
    handler,
    valid_text,
    invalid_range_text,
    expected_value,
...
@_price_params
async def test_edit_price_success_message(
    handler,
    valid_text,
    invalid_range_text,
    expected_value,
...
@_price_params
async def test_edit_price_update_error(
    handler,
    valid_text,
    invalid_range_text,
    expected_value,
...
@_price_params
async def test_edit_price_calls_helper(
    handler,
    valid_text,
    invalid_range_text,
    expected_value,
...
@_price_params
async def test_edit_price_no_bot_skips_helper(
    handler,
    valid_text,
    invalid_range_text,
    expected_value,
...
@_price_params
async def test_edit_price_unexpected_error_clears(
    handler,
    valid_text,
    invalid_range_text,
    expected_value,
...
async def test_update_message_success(mock_bot, mock_message_bus, sample_nike_search):
    mock_message_bus.query.return_value = sample_nike_search
...
async def test_update_message_query_error(mock_bot, mock_message_bus):
    mock_message_bus.query.side_effect = Exception("db error")
...
async def test_update_message_not_found(mock_bot, mock_message_bus):
    mock_message_bus.query.return_value = None
...
async def test_update_message_build_error(
    mock_bot, mock_message_bus, sample_nike_search, mocker
):
    mock_message_bus.query.return_value = sample_nike_search
    mocker.patch(
        "src.telegram_bot.routers.my_searches.build_my_search_listing_message",
...
async def test_resolve_search_from_callback_query_error(
    mock_callback_query, mock_message_bus
):
    mock_callback_query.data = "remove_1"
    mock_message_bus.query.side_effect = Exception("db error")
...
async def test_resolve_search_from_callback_not_found(
    mock_callback_query, mock_message_bus
):
    mock_callback_query.data = "remove_1"
    mock_message_bus.query.return_value = None
...
async def test_resolve_search_from_callback_not_message_instance(
    mock_callback_query, mock_message_bus, sample_nike_search
):
    mock_callback_query.data = "remove_1"
    mock_message_bus.query.return_value = sample_nike_search
...
async def test_resolve_search_from_callback_success_returns_tuple(
    mock_callback_query, mock_message_bus, sample_nike_search
):
    mock_callback_query.data = "remove_1"
    mock_message_bus.query.return_value = sample_nike_search
...
async def test_validate_callback_valid_returns_data_and_message(mock_callback_query):
...
async def test_validate_callback_valid_double_prefix(mock_callback_query):
...
async def test_validate_callback_missing_data(mock_callback_query):
    mock_callback_query.data = None
...
async def test_validate_callback_missing_message(mock_callback_query):
    mock_callback_query.data = "remove_1"
    mock_callback_query.message = None
...
async def test_validate_callback_wrong_prefix(mock_callback_query):
    mock_callback_query.data = "edit_1"
...
async def test_validate_callback_not_message_instance(mock_callback_query):
    mock_callback_query.data = "remove_1"
    mock_callback_query.message = MagicMock()  # Not a Message instance
